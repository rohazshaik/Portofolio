...
export default function InfiniteGallery({
	...
	return (
		<div className={className} style={{ ...style, position: 'relative', backgroundColor: '#000000' }}>
			<Canvas
			...
			<div className="absolute inset-0 pointer-events-none flex flex-col items-center justify-center z-10 select-none">
				...
				<h1
					...
					style={{
						fontSize: 'clamp(20px, 10vw, 52px)',
						fontFamily: 'var(--font-instrument), "Instrument Serif", "Playfair Display", serif',
						fontStyle: 'italic',
						fontWeight: 300,
						color: '#FFFFFF',
						letterSpacing: '2px',
				...
				{/* BOTTOM INSTRUCTIONS */}
				<div
					className="absolute bottom-0 left-0 right-0 flex flex-col items-center justify-center pb-12 pointer-events-none"
					style={{ opacity: 0.7 }}
				>
					<p
						style={{
							fontSize: 'clamp(9px, 2vh, 9px)',
							fontFamily: 'var(--font-geist-mono), "Geist Mono", "Courier New", monospace',
							fontWeight: 500,
							color: '#888888',
							letterSpacing: '1px',
							lineHeight: 1.6,
